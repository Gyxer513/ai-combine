...
BLURB = {
    "assistant": "общий помощник: ресёрч, поиск, бытовые вопросы",
    "recon": "информационная безопасность: скан и хардненинг твоей инфры",
    "coder": "код и инженерия: пишу и ревьюю код, гоняю тесты",
    "planner": "планировщик: режу ТЗ проекта на задачи для агентов",
}
